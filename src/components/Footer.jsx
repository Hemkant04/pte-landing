      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="sm:col-span-2 md:col-span-2">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 mb-6 max-w-md transition-colors duration-300 text-sm leading-relaxed">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.tiktok.com/@apeuninepal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-zinc-100 dark:bg-white/10 rounded-lg flex items-center justify-center hover:bg-zinc-200 dark:hover:bg-white/20 ring-1 ring-zinc-200 dark:ring-white/20 transition-colors duration-300 overflow-hidden p-1.5">
          ...
          <div>
            <h4 className="text-zinc-900 dark:text-white font-semibold mb-4 transition-colors duration-300 text-sm uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-2">
              <li><Link to="/" className="text-sm hover:text-accent transition-colors">Home</Link></li>
              <li><Link to="/practice-package" className="text-sm hover:text-accent transition-colors">Buy MockTest</Link></li>
              <li><Link to="/date-booking" className="text-sm hover:text-accent transition-colors">Date Booking</Link></li>
              <li><Link to="/downloads" className="text-sm hover:text-accent transition-colors">Downloads</Link></li>
              <li><Link to="/about" className="text-sm hover:text-accent transition-colors">About Us</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-zinc-900 dark:text-white font-semibold mb-4 transition-colors duration-300 text-sm uppercase tracking-wider">Contact Us</h4>
            <ul className="space-y-3">
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-accent" />
                <a href="tel:9762419564" className="text-sm hover:text-accent transition-colors">9762419564</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent" />
                <a href="mailto:apeuninepal01@gmail.com" className="text-sm hover:text-accent transition-colors">apeuninepal01@gmail.com</a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                <span className="text-sm text-zinc-600 dark:text-zinc-400 transition-colors duration-300">Lalitpur, Nepal</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-zinc-200 dark:border-white/10 mt-12 pt-8 text-center text-sm text-zinc-500 transition-colors duration-300">
          ...
          <p className="mt-2 text-xs">PTE Academic is a registered trademark of Pearson Education Inc. We are an independent preparation service.</p>
        </div>
      </div>
    </footer>
  );
